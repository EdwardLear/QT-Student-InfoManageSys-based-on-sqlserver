...
#include<qsqlquery.h>
dormanage::dormanage(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::dormanage)
{
    ui->setupUi(this);
...
void dormanage::on_dorm_queryButton_clicked()
{
...
void dormanage::on_dorm_addButton_clicked()
{
...
void dormanage::on_dorm_deleteButton_clicked()
{
    QString id=ui->dorm_inputlineEdit->text();
...
void dormanage::on_updateButton_clicked()
{
    QString id=ui->dorm_inputlineEdit->text();
    QString dormnum=ui->dormqingshi_numlineEdit->text();
    QString name=ui->dorm_namelineEdit->text();
...
void dormanage::on_dorm_backButton_clicked()
{
    this->hide();
    manager *lk=new manager;
    lk->show();
}

void dormanage::on_see_all_dorm_Button_clicked()
{
    QSqlDatabase db;
    if(QSqlDatabase::contains("Myconnection"))
        db = QSqlDatabase::database("Myconnection");
    ...
    this->hide();
     seedorminfo *ol=new  seedorminfo;
    ol->show();
}
